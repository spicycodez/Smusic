...
YT_API_KEY = getenv("YT_API_KEY", "xbit_issQbNpQKwoZaRVBQtEogF1kcbVorV4I") # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com')

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/spicycodez/Smusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+sTyS-zKwUIk4YWI1")
