...
API_KEY = getenv("API_KEY", "xbit_issQbNpQKwoZaRVBQtEogF1kcbVorV4I") # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz
